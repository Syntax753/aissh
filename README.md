# AISSH - Avoid Intrusion to Super Secret Home

This is a placeholder README.md for AISSH - Avoid Intrusion to Super Secret Home.

What does AISSH - Avoid Intrusion to Super Secret Home do? I have no idea. It will be up to you, the developer of AISSH - Avoid Intrusion to Super Secret Home, to describe it.
...
Point your users to some public forum. Then they will be able to join forces to more effectively complain about your work! If you'd like a channel for your app on the [AISSH - Avoid Intrusion to Super Secret Homes Discord server](https://discord.gg/kkp3x4X2Vb), just ask - we can probably do it. The channel would be named "AISSH - Avoid Intrusion to Super Secret Home". And what do people in that channel talk about? AISSH - Avoid Intrusion to Super Secret Home, of course.
...
## Running AISSH - Avoid Intrusion to Super Secret Home during Development
...
The unmodified template installed for AISSH - Avoid Intrusion to Super Secret Home includes these screens:
...
* Otherwise, common functionality can go in a source file under `/common`.# aissh
